...
# ---------------------------------------------------------------- YOUR CODE
TASK = "Write a formal leave application from an engineering student requesting 2 days of medical leave due to viral fever."

CRITERIA = [
    "Under 120 words.",
    "Must explicitly include placeholders for student name, roll number, and department.",
    "Must clearly state the reason for leave as viral fever and the duration as 2 days.",
    "Contains no informal greetings, slang, or exclamation marks.",
]
# ------------------------------------------------------------ END YOUR CODE
